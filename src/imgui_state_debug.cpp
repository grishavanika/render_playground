...
void ImGui_Setup(AppState& app)
{
    ...
    app.window_.set_message_handler([](HWND hwnd, UINT message, WPARAM wparam, LPARAM lparam) -> LRESULT {
...
void ImGui_ShadersInput(ImGuiState& imgui)
{
    ...
    ImGui::SameLine();
    ImGui::BeginGroup();
    if ((used_vs_now != imgui.model_vs_index) || (used_ps_now != imgui.model_ps_index))
    {
