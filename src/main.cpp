...
int WINAPI _tWinMain(HINSTANCE /*hInstance*/, HINSTANCE /*hPrevInstance*/, LPTSTR /*lpCmdLine*/, int /*nCmdShow*/)
{
    ...
    render_lines.add_bb(glm::vec3(-1.f), glm::vec3(1.f), glm::vec3(1.f, 0.f, 0.f));
    // Positive World X direction. RED.
    render_lines.add_line(glm::vec3(0.f, 0.f, 0.f), glm::vec3(1.f, 0.f, 0.f), glm::vec3(1.f, 0.f, 0.f));
    // Positive World Y direction. GREEN.
    render_lines.add_line(glm::vec3(0.f, 0.f, 0.f), glm::vec3(0.f, 1.f, 0.f), glm::vec3(0.f, 1.f, 0.f));
    // Positive World Z direction. BLUE.
    render_lines.add_line(glm::vec3(0.f, 0.f, 0.f), glm::vec3(0.f, 0.f, 1.f), glm::vec3(0.f, 0.f, 1.f));
    ...
    while (WM_QUIT != msg.message)
    {
        ...
        projection = glm::perspectiveFovLH(
            app.fov_y_,
            app.window_width_,
            app.window_height_,
            0.01f, // NearZ
        ...
        {
            wfd.FillMode = app.imgui_.wireframe ? D3D11_FILL_WIREFRAME : D3D11_FILL_SOLID;
        ...
        app.device_context_->ClearDepthStencilView(
            app.depth_buffer_.Get(), D3D11_CLEAR_DEPTH | D3D11_CLEAR_STENCIL, 1.0f, 0
        );
